        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden border border-gray-100">
                <div class="relative h-48 bg-gray-200">
                    <img src="https://via.placeholder.com/400x200" alt="Logo Design" class="w-full h-full object-cover">
                ...
                <div class="p-4">
                    <div class="flex justify-between items-start">
                        <h3 class="text-lg font-semibold text-gray-800">Logo Design</h3>
                    ...
                    <p class="mt-2 text-sm text-gray-600 line-clamp-2">Professional logo design with unlimited revisions and source files included.</p>
                    
                    <!-- Packages Preview -->
                    <div class="mt-3">
                        <div class="text-xs text-gray-500 uppercase font-medium">Packages:</div>
                        <div class="mt-1 flex flex-wrap gap-2">
                            <span class="px-2 py-1 bg-gray-100 text-gray-800 text-xs rounded-full">Basic: $50</span>
                            <span class="px-2 py-1 bg-gray-100 text-gray-800 text-xs rounded-full">Premium: $120</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="mt-1 flex flex-wrap gap-2">
                            <span class="px-2 py-1 bg-indigo-100 text-indigo-800 text-xs rounded-full">Design</span>
                            <span class="px-2 py-1 bg-indigo-100 text-indigo-800 text-xs rounded-full">Branding</span>
                        </div>
                    </div>
                    
                    <div class="mt-4 flex justify-end space-x-2">
                        <button class="edit-service-btn px-3 py-1 text-sm text-indigo-600 hover:text-indigo-800 border border-indigo-600 hover:border-indigo-800 rounded" data-service-id="1">
                            Edit
                        </button>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden border border-gray-100">
                <div class="relative h-48 bg-gray-200">
                    <img src="https://via.placeholder.com/400x200" alt="Web Development" class="w-full h-full object-cover">
                ...
                <div class="p-4">
                    ...
                    <p class="mt-2 text-sm text-gray-600 line-clamp-2">Custom responsive website development with modern technologies and SEO optimization.</p>
                    
                    <!-- Packages Preview -->
                    <div class="mt-3">
                        <div class="text-xs text-gray-500 uppercase font-medium">Packages:</div>
                        <div class="mt-1 flex flex-wrap gap-2">
                            <span class="px-2 py-1 bg-gray-100 text-gray-800 text-xs rounded-full">Basic: $300</span>
                            <span class="px-2 py-1 bg-gray-100 text-gray-800 text-xs rounded-full">Standard: $700</span>
                            <span class="px-2 py-1 bg-gray-100 text-gray-800 text-xs rounded-full">Premium: $1500</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        <div class="text-xs text-gray-500 uppercase font-medium">Tags:</div>
                        <div class="mt-1 flex flex-wrap gap-2">
                            <span class="px-2 py-1 bg-indigo-100 text-indigo-800 text-xs rounded-full">Web</span>
                            <span class="px-2 py-1 bg-indigo-100 text-indigo-800 text-xs rounded-full">Development</span>
                        </div>
                    </div>
                    
                    <div class="mt-4 flex justify-end space-x-2">
                        <button class="edit-service-btn px-3 py-1 text-sm text-indigo-600 hover:text-indigo-800 border border-indigo-600 hover:border-indigo-800 rounded" data-service-id="2">
                            Edit
                        </button>
                        <button class="px-3 py-1 text-sm text-red-600 hover:text-red-800 border border-red-600 hover:border-red-800 rounded">
                            Delete
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden border border-gray-100">
                <div class="relative h-48 bg-gray-200">
                    <img src="https://via.placeholder.com/400x200" alt="Content Writing" class="w-full h-full object-cover">
                ...
                <div class="p-4">
                    <div class="flex justify-between items-start">
                        <h3 class="text-lg font-semibold text-gray-800">Content Writing</h3>
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor">
                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                            </svg>
                    ...
                    <p class="mt-2 text-sm text-gray-600 line-clamp-2">SEO-optimized blog posts, articles, and website content that engages your audience.</p>
                    
                    <!-- Packages Preview -->
                    <div class="mt-3">
                        <div class="text-xs text-gray-500 uppercase font-medium">Packages:</div>
                        <div class="mt-1 flex flex-wrap gap-2">
                            <span class="px-2 py-1 bg-gray-100 text-gray-800 text-xs rounded-full">500 words: $25</span>
                            <span class="px-2 py-1 bg-gray-100 text-gray-800 text-xs rounded-full">1000 words: $45</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        <div class="text-xs text-gray-500 uppercase font-medium">Tags:</div>
                        <div class="mt-1 flex flex-wrap gap-2">
                            <span class="px-2 py-1 bg-indigo-100 text-indigo-800 text-xs rounded-full">Writing</span>
                            <span class="px-2 py-1 bg-indigo-100 text-indigo-800 text-xs rounded-full">SEO</span>
                        </div>
                    </div>
                    
                    <div class="mt-4 flex justify-end space-x-2">
                        <button class="edit-service-btn px-3 py-1 text-sm text-indigo-600 hover:text-indigo-800 border border-indigo-600 hover:border-indigo-800 rounded" data-service-id="3">
                            Edit
                        </button>
                        <button class="px-3 py-1 text-sm text-red-600 hover:text-red-800 border border-red-600 hover:border-red-800 rounded">
                            Delete
