    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-white border-r border-gray-200 fixed inset-y-0 left-0 z-50">
            ...
            <nav class="p-4">
                ...
                <div class="mb-6">
                    ...
                    <a href="{{ route('admin.users') }}" class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 @if(Route::is('admin.account-validation')) bg-gradient-to-r from-purple-100/50 to-pink-100/50 border-r-4 border-pink-500 @endif">
                        <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                        </svg>
                        Account Validation
                    </a>
                    <a href="{{ route('admin.categories') }}" class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 @if(Route::is('admin.profile-moderation')) bg-gradient-to-r from-purple-100/50 to-pink-100/50 border-r-4 border-pink-500 @endif">
                        <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mb-6">
                    ...
                    <a href="{{ route('admin.reviews') }}" class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 @if(Route::is('admin.reviews')) bg-gradient-to-r from-purple-100/50 to-pink-100/50 border-r-4 border-pink-500 @endif">
                        <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>
                        </svg>
                        Reviews
        ...
        <div class="flex-1 flex flex-col min-h-screen ml-64">
            <header class="h-16 bg-white shadow-md flex items-center justify-between px-6">
                ...
                <div class="flex items-center space-x-4">
                    <div class="relative">
                        <input type="text" id="searchInput" placeholder="@yield('search-placeholder', 'Search...')" class="w-48 pl-10 pr-4 py-2 rounded-lg border border-gray-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 text-sm"/>
                    ...
                    <button class="flex items-center px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-lg" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
